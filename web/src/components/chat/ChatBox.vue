			...
			<el-main style="padding: 0;">
				<el-container>
					<el-container class="content-box">
						<el-main class="yeying-chat-main" id="chatScrollBox" @scroll="onScroll">
							<div class="yeying-chat-box">
						...
						<el-footer height="220px" class="yeying-chat-footer">
